...
// fista_ee
Rcpp::List fista_ee(const arma::vec& y, const arma::mat& X, const arma::vec& lam1, const arma::vec& lam2, arma::vec b, const uint& maxit, const double& tol, const double& L, const bool& verbose, const bool& acc);
RcppExport SEXP _fglm_fista_ee(SEXP ySEXP, SEXP XSEXP, SEXP lam1SEXP, SEXP lam2SEXP, SEXP bSEXP, SEXP maxitSEXP, SEXP tolSEXP, SEXP LSEXP, SEXP verboseSEXP, SEXP accSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fista_ee(y, X, lam1, lam2, b, maxit, tol, L, verbose, acc));
    return rcpp_result_gen;
END_RCPP
}
// obj_diff_cpp
Rcpp::List obj_diff_cpp(const arma::vec& y, const arma::mat& X, const arma::vec& b, const arma::vec& lam1, const arma::vec& lam2, const uint& order);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(obj_diff_cpp(y, X, b, lam1, lam2, order));
    return rcpp_result_gen;
END_RCPP
}
// soft_t
...
// prox_newt
Rcpp::List prox_newt(const arma::vec& y, const arma::mat& X, const arma::vec& lam1, const arma::vec& lam2, arma::vec b, const arma::uvec& maxit, const arma::vec& tol, const bool& verbose, const bool& linsearch);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(prox_newt(y, X, lam1, lam2, b, maxit, tol, verbose, linsearch));
    return rcpp_result_gen;
END_RCPP
}
